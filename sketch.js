...
function setup() {
	...
	bob2 = Bodies.circle(325,300,25,bob_options);
	World.add(world,bob2);

	bob3 = Bodies.circle(350,300,25,bob_options);
	World.add(world,bob3);

	bob4 = Bodies.circle(375,300,25,bob_options);
	World.add(world,bob4);

	bob5 = Bodies.circle(400,300,25,bob_options);
